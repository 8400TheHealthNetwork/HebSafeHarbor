...
from presidio_analyzer import RecognizerResult, LemmaContextAwareEnhancer
...
class HebrewContextAwareEnhancer(ContextAwareEnhancer):
    ...
    def __init__(
        ...
        self.substring_processed_recognizers_list = substring_processed_recognizers_list
    ...
    def enhance_using_context(
        ...
        for result in results:
            ...
            if recognizer.name in self.substring_processed_recognizers_list:
                ...
                elif recognizer.name not in self.substring_processed_recognizers_list:
